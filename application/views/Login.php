...
<body>
    <h1 class="title-agile text-center">Login Psycho Care Malang</h1>
    <div class="content-w3ls">
        <div class="content-top-agile">
            <h2>Log in</h2>
        </div>
        <div class="content-bottom">
            <form action="<?php echo base_url(); ?>login/pelanggan" method="post">
                <div class="field-group">
                    <span class="fa fa-user" aria-hidden="true"></span>
                    <div class="wthree-field">
                        <input name="username" id="username" type="text" value="" placeholder="Email" required>
                    </div>
                </div>
                <div class="field-group">
