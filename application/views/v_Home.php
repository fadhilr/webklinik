...
<head>
	<title>Klinik Psycho Care Malang</title>
	<!-- Meta tag Keywords -->
						...
						<div class="col-xl-5 col-lg-6 col-md-8 top-social-agile text-lg-left text-center">
							<div class="row">
								<div class="col-4 header-top_w3layouts">
									<p class="text-bl">
										<span class="fa fa-map-marker mr-2"></span>Malang
									</p>
								</div>
								<div class="col-4 header-top_w3layouts">
									<p class="text-bl">
										<span class="fa fa-phone mr-2"></span>+62 800263676
									</p>
								</div>
								<!-- social icons -->
					...
					<div id="logo">
						<h1>
							<a href="index.html">
								...
								<span class="logo-sp">Psycho</span> Care Malang
							</a>
						</h1>
					</div>
					<!-- //logo -->
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<img class="card-img-bottom" src="<?php echo base_url();?>assets/images/blog1.jpg" alt="image">
						</div>
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<img class="card-img-bottom" src="<?php echo base_url();?>assets/images/blog3.jpg" alt="image">
						</div>
						<div class="card-body border border-top-0">
							<div class="mb-3">
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<img class="card-img-bottom" src="<?php echo base_url();?>assets/images/blog2.jpg" alt="image">
						</div>
						<div class="card-body border border-top-0">
							<div class="mb-3">
		...
		<div class="container pb-xl-5 pb-lg-3">
			...
			<div class="row mt-sm-5">
				<div class="offset-lg-4 col-lg-4 col-sm-6">
					<div class="box16">
						<img src="<?php echo base_url();?>assets/images/team3.jpg" alt="" class="img-fluid">
						<div class="box-content">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="box16">
						<img src="<?php echo base_url();?>assets/images/team4.jpg" alt="" class="img-fluid">
						<div class="box-content">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="single.html">
								<img class="card-img-bottom" src="<?php echo base_url();?>assets/images/g1.jpg" alt="image">
							</a>
						</div>
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						...
						<div class="card-header p-0">
							<a href="single.html">
								<img class="card-img-bottom" src="<?php echo base_url();?>assets/images/g3.jpg" alt="image">
							</a>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="single.html">
								<img class="card-img-bottom" src="<?php echo base_url();?>assets/images/g2.jpg" alt="image">
							</a>
						</div>
						<div class="card-body border border-top-0 pb-5">
							<div class="mb-3">
			...
			<div class="row mt-5">
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="single.html">
								<img class="card-img-bottom" src="<?php echo base_url();?>assets/images/g4.jpg" alt="image">
							</a>
						</div>
						<div class="card-body border border-top-0 pb-5">
							<div class="mb-3">
