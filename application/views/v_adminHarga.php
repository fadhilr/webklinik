	...
	<section class="content">
	  <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Tabel Harga</h3>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <form role="form" action="<?php echo base_url(); ?>c_admin/set_harga" method="post" enctype="multipart/form-data">
                <thead>
                <tr>
        ...
        <tr data-id="" >
                  ...
                  <input type="text" id="hargaPendaftaran" class="harga" data-idGejala="<?php echo "$a[idHarga]"?>" value="<?php echo "$a[hargaPendaftaran]" ?> " name="hargaPendaftaran" placeholder="" data-namaKolom="hargaPendaftaran">
                </div></td>
                  <td><div class="form-group">
                  <input type="text" id="hargaPemeriksaan" class="harga" data-idGejala="<?php echo "$a[idHarga]"?>" value="<?php echo "$a[hargaPemeriksaan]" ?> " name="hargaPemeriksaan" placeholder="" data-namaKolom="hargaPemeriksaan">
                </div></td>
                  
                  <td><div class="btn-group">
                    <button type="submit" class="btn btn-warning btn-flat">
                      <a href="<?php echo base_url(); ?>c_admin/set_harga" type="button"><i class="fa fa fa-gear"></i></a></button>
...
<script>
  ...
  $(document).ready(function(){
        $(".harga").change(function() { 
          var idHarga= $(this).attr("data-idGejala");
          ...
          // var value= $(this).val();
              ...
              $.ajax({
                    ...
                    url: "<?php echo base_url('c_admin/set_harga'); ?>",
                    data: {  idHarga:idHarga, namaKolom:namaKolom, value:value }
