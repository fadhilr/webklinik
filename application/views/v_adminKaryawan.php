	...
	<section class="content">
	  <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="col-lg-3 col-xs-6">
             <a href="<?php echo base_url();?>c_admin/tampilanAdminKaryawanTambah">
              <button type="button" class="btn  btn-success btn-lg"><i class="fa fa-plus"> </i>Tambah Karyawan</button>
              </a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <tr data-id="" >
                  ...
                  <td><?php echo "$a[namaKaryawan]" ?></td>
                  <td><?php echo "$a[noHp]" ?></td>
                  <td><a href="<?php echo base_url(); ?>assets/images/foto/<?php echo "$a[fotoKaryawan]" ?>" data-lightbox="image-1" data-title="My caption">
          <img src="<?php echo base_url(); ?>assets/images/foto/<?php echo "$a[fotoKaryawan]" ?>" width="100px" height: "100px"></a></td>
                  <td><?php echo "$a[status]" ?></td>
                  <td><div class="btn-group">
                      <a href="<?php echo base_url(); ?>c_admin/tampilanAdminKaryawanDetail/<?php echo "$a[idKaryawan]" ?>" type="button" class="btn btn-info btn-flat"><i class="fa fa-info"></i></a>
