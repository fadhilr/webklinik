    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url(); ?>c_admin/tampilanAdminNotifikasi">Notifikasi Pelanggan</a></li>
	  ...
	  <div class="col-md-3">
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url(); ?>c_admin/set_notifikasi/" method="post">
              <div class="box-body">
        ...
        ?>
          ...
          ?>
          <option value="<?php echo $f->idPelanggan; ?>" ><?php echo $f->username; ?></option>
