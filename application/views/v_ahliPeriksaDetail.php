...
<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Isi Hasil Pemeriksaan</h3>
            </div>
        ...
        ?>
                <tr>
                  ...
                  <td>:</td>
                  <td><?php print_r($isi['hasil']) ?></td>
                </tr>
                <tfoot>
                  <th>Kesimpulan Ahli</th>
                  <th> <div class="form-group">
                  <input type="text" id="waktu" class="dataPemeriksaan" data-idGejala="<?php echo "$a[idHasil]"?>" value="<?php echo "$a[kesimpulan]"?> " name="keterangan" placeholder="Masukkan kesimpulan" data-namaKolom="kesimpulan">
                </div></th>
                </tfoot>
        ...
        $(".dataPemeriksaan").change(function() { 
          ...
          // var value= $(this).val();
              ...
              $.ajax({
                    ...
                    url: "<?php echo base_url('c_ahli/set_data_pemeriksaan'); ?>",
          ...
          console.log(dataNama);
            if (dataNama=="tambahan") {
              $.ajax({
                    ...
                    url: "<?php echo base_url('c_ahli/tambahData'); ?>",
                    data: { idPelanggan:idPelanggan, idAhli:idAhli, idData:idData, namaKolom:namaKolom, value:value }

                });
            } else {
                $.ajax({
                    url: "<?php echo base_url('c_ahli/set_data_pemeriksaan2'); ?>",
                    data: { idPelanggan:idPelanggan, idAhli:idAhli, idData:idData, namaKolom:namaKolom, value:value }
