    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="<?php echo base_url(); ?>welcome/cliant_dashboard" class="navbar-brand"><b>Psycho Care</b>Malang</a>
...
<section class="content">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Diagnosa akhir dan pengaturan perilaku</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  <div class="col-sm-6">
          <strong>A. Identitas Klien</strong></br>
            Nama : <br>
            Umur :<br>
            Jenis Kelamin :<br>
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          <strong>B. Hasil Pemeriksaan</strong>
          <table class="table table-striped">
            ...
            <tr>
              <td>1</td>
              <td>Kartu Alumni</td>
              <td>Kartu Alumni Universitas Brawijaya <span></span></td>
              <td>Rp. <span></span>,-</td>
            </tr>
            </tbody>
          </table>
