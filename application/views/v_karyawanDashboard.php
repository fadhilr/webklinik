...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <div class="row">
        ...
        <tr data-id="" >
          ...
          <td> <?php echo "$a[tampilan]" ?></td>
                  <td><div class="btn-group">
                      <a href="<?php echo base_url(); ?>c_karyawan/set_lanjutHasilPeriksa/<?php echo "$a[idPelanggan]" ?>"><button type="button" class="btn btn-info btn-flat" 
            ...
            <a href="<?php echo base_url(); ?>c_karyawan/jenisPeriksa/<?php echo "$a[idPelanggan]" ?>" type="button" class="btn btn-success btn-flat" 
            data-nama = "<?php echo "$a[namaPelanggan]"?>" data-id="<?php echo "$a[idPelanggan]"?>"><i class="fa fa-stethoscope"></i></a> 
                    </div></td>
		...
		<div class="col-sm-6 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Perkembangan Pelanggan Pending</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				        <?php
          foreach ($pelangganPerkembangan as $a) {
        ...
        <tr data-id="" >
          ...
          <td> <?php echo "$a[tampilan]" ?></td>
                  <td><div class="btn-group">
                      <a href="<?php echo base_url(); ?>c_karyawan/set_lanjutHasilPerkembangan/<?php echo "$a[idPelanggan]" ?>"><button type="button" class="btn btn-info btn-flat" 
            data-nama = "<?php echo "$a[namaPelanggan]"?>" data-id="<?php echo "$a[idPelanggan]"?>" ><i class="fa fa-chevron-circle-right"></i></button></a>
                      
            <a href="" type="button" class="btn btn-warning btn-flat"><i class="fa fa-send"></i></a>
            <a href="<?php echo base_url(); ?>c_karyawan/jenisPeriksa2/<?php echo "$a[idPelanggan]" ?>" type="button" class="btn btn-success btn-flat" 
            data-nama = "<?php echo "$a[namaPelanggan]"?>" data-id="<?php echo "$a[idPelanggan]"?>"><i class="fa fa-stethoscope"></i></a>
    ...
    <input type="hidden" id="alumni-id" name = "alumni-id" value="<?php echo $this->session->userdata('idKaryawan')?>" >
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
...
$(document).on("click",".hapus-member",function(){
 ...
 function load_unseen_notification(view = '')
 {
  ...
  $.ajax({
   url:"<?php echo base_url('Notifikasi/karyawan'); ?>",
   method:"POST",
