...
<div class="wrapper">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Tabel Pasien yang diperiksa</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <tr data-id="" >
          ...
          <img src="<?php echo base_url(); ?>assets/images/foto/<?php echo "$a[fotoPelanggan]" ?>" width="100px" height: "100px"></a></td>
                  ...
                  <td><div class="btn-group">
                      <a href="<?php echo base_url(); ?>c_karyawan/tampilanKaryawanPelangganDetail/<?php echo "$a[idPelanggan]" ?>" type="button" class="btn btn-info btn-flat"><i class="fa fa-info"></i></a>
  ...
  <footer class="main-footer">
    ...
    <strong>&copy; 2019 DEVELOPED BY <a href="<?php echo base_url(); ?>">Psycho Care Malang</a>.</strong> ALL RIGHTS RESERVED.
  </footer>
