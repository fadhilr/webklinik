...
<section class="content">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <div class="box-body">
          <b>ID pembayaran:</b> <?php echo $idPembayaran ?><br>
              <hr>
      </div>
              <div class="box-body">
        ...
        <div class="col-sm-6">
          Kepada
          <address>
            <strong><?php echo $namaPelanggan ?></strong><br>
            <span><?php echo $alamat ?></span><br>
            No. HP: <span><?php echo $noHp ?> </span><br>
          </address>
        </div>
      </div>
      <!-- /.row -->
      ...
      <div class="row">
        <div class="box-body">
          <br>Pembayaran untuk pendaftaran dan pemeriksaan
        </div>
      ...
      <div class="row">
        ...
        <!-- /.col -->
		<form action="<?php echo base_url(); ?>c_pelanggan/set_pembayaran/" method="post" enctype="multipart/form-data">
        <div class="row">
        <div class="box-body">
        <div class="col-xs-6">
          <br><br>
          <div class="table-responsive">
            <table class="table" width="50%">
              <tr>
                ...
                <td>Rp.<span><?php echo $hargaPendaftaran ?></span>,-</td>
              </tr>
              <tr>
                <th>Biaya Pemeriksaan:</th>
                <td>Rp.<span><?php echo $hargaPemeriksaan ?></span>,-</td>
              </tr>
              <tr>
                <th>Total:</th>
                <td>Rp.<span><?php echo $total ?></span>,-</td>
              </tr>
			  <tr>
                <th>Upload Bukti Pembayaran:</th>
                <td><img src="<?php echo base_url(); ?>assets/images/pembayaran/<?php echo $buktiPembayaran1 ?>" width="200px" height: "300px"><input id = "foto" name="foto" type="file" class="">
          </input></td>
              </tr>
            </table>
          </div>
