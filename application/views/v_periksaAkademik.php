    ...
    <section class="content">
	  ...
	  <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Tabel Pemeriksaan Akademik</h3>
            </div>
            <!-- /.box-header -->
             <form action="<?php echo base_url(); ?>c_karyawan/set_akademik" method="post">
            <div class="box-body">
        ...
        <tr data-id="DataPsikomotor" >
                  ...
                  <input type="text" id="waktu" class="dataAkademik" data-idGejala="<?php echo "$a[idData]"?>" value="<?php foreach ($nilai_akademik as $b) {if ($b['idData']==$a['idData']){print_r($b['waktu']); }};?> " name="waktu" placeholder="Masukkan waktu" data-namaKolom="waktu" data-tahap="1">
                </div></td>
                  <td><div class="form-group">
                  <input type="text" id="waktu" class="dataAkademik" data-idGejala="<?php echo "$a[idData]"?>" value="<?php foreach ($nilai_akademik as $b) {if ($b['idData']==$a['idData']){print_r($b['keterangan']); }};?> " name="waktu" placeholder="Masukkan waktu" data-namaKolom="keterangan" data-tahap="1">
                </div></td>
        ...
        $(".akademik").change(function() { 
          ...
          console.log(psikomotor);
            if(psikomotor=="akademik3") { 
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_akademik'); ?>",
