    ...
    <section class="content">
	  ...
	  <div class="row">
        <div class="col-xs-12">
         ...
         <div class="box box-primary">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="#ambil" data-toggle="tab">Perkembangan Akademik</a></li> 
              <li><a href="#sl" data-toggle="tab">Perkembangan SL</a></li>
        ...
        <tr data-id="DataPsikomotor" >
                  ...
                  <input type="text" id="waktu" class="dataAkademik" data-idGejala="<?php echo "$a[idData]"?>" value="<?php foreach ($nilai_akademik as $b) {if ($b['idData']==$a['idData']){print_r($b['waktu']); }};?> " name="waktu" placeholder="Masukkan waktu" data-namaKolom="waktu" data-tahap="2">
                </div></td>
                  <td><div class="form-group">
                  <input type="text" id="waktu" class="dataAkademik" data-idGejala="<?php echo "$a[idData]"?>" value="<?php foreach ($nilai_akademik as $b) {if ($b['idData']==$a['idData']){print_r($b['keterangan']); }};?> " name="waktu" placeholder="Masukkan waktu" data-namaKolom="keterangan" data-tahap="2">
                </div></td>
        ...
        ?>
                <tr>
                  <td>Hasil</td>
                  <td></td>
                  <td><?php foreach ($nilai_akademik as $b) {if ($b['idData']==$a['idData']){print_r($b['nilai']); }};?></td>
                </tr>
                </tbody>
                <tfoot>
                <tr>
        ...
        <tr data-id="DataSL" >
                  ...
                  <td><input type="radio" name="sl<?php echo "$a[idGejala]"?>" class="sl" data-idGejala="<?php echo "$a[idGejala]"?>" id="sl1" value="" <?php foreach ($nilai_sl as $b) {if ($b['idGejala']==$a['idGejala'] && $b['idPelanggan']==$idPelanggan){if ($b['nilai']==1){echo "checked";}}};?>></td>
                  <td><input type="radio" name="sl<?php echo "$a[idGejala]"?>" class="sl" data-idGejala="<?php echo "$a[idGejala]"?>" id="sl2" value="" <?php foreach ($nilai_sl as $b) {if ($b['idGejala']==$a['idGejala'] && $b['idPelanggan']==$idPelanggan){if ($b['nilai']==0){echo "checked";}}};?>></td>
   ...
   $(document).ready(function(){
        $(".akademik").change(function() { 
          ...
          console.log(psikomotor);
            if(psikomotor=="akademik3") { 
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_akademik2'); ?>",
                    data: { idPelanggan:idPelanggan, idKaryawan:idKaryawan, idData:idData, strState:30 }
                });
            } else if(psikomotor=="akademik2") { 
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_akademik2'); ?>",
  ...
  $(document).ready(function(){
        $(".dataAkademik").change(function() { 
          ...
          console.log(idData);
                ...
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_data_akademik'); ?>",
  ...
  $(document).ready(function(){
        $(".sl").change(function() { 
          ...
          console.log(tunalaras);
            if(tunalaras=="sl1") { 
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_sl'); ?>",
