    ...
    <section class="content">
	  ...
	  <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Tabel Pemeriksaan Psikomotor</h3>
            </div>
            <!-- /.box-header -->
        ...
        <tr data-id="DataPsikomotor" >
                  ...
                  <input type="text" id="nama" class="dataPsikomotor" data-idGejala="<?php echo "$a[idData]"?>" value="<?php foreach ($nilai_psikomotor as $b) {if ($b['idData']==$a['idData']){print_r($b['waktu']); }};?> " name="nama" placeholder="Masukkan waktu" data-namaKolom="waktu" data-tahap="1">
                </div></td>
                  <td><div class="form-group">
                  <input type="text" id="nama" class="dataPsikomotor" data-idGejala="<?php echo "$a[idData]"?>" value="<?php foreach ($nilai_psikomotor as $b) {if ($b['idData']==$a['idData']){print_r($b['keterangan']); }};?>" name="nama" placeholder="Masukkan keterangan" data-namaKolom="keterangan" data-tahap="1">
                </div></td>
        ...
        $(".psikomotor").change(function() { 
          ...
          console.log(psikomotor);
            if(psikomotor=="psikomotor3") { 
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_psikomotor'); ?>",
