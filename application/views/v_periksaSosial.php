    ...
    <section class="content">
	  ...
	  <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Tabel Pemeriksaan Sosial</h3>
            </div>
            <!-- /.box-header -->
            <form action="<?php echo base_url(); ?>c_karyawan/set_sosial" method="post">
            <div class="box-body">
        ...
        <tr data-id="DataPsikomotor" >
                  ...
                  <input type="text" id="waktu" class="dataSosial" data-idGejala="<?php echo "$a[idData]"?>" value="<?php foreach ($nilai_sosial as $b) {if ($b['idData']==$a['idData']){print_r($b['waktu']); }};?> " name="waktu" placeholder="Masukkan waktu" data-namaKolom="waktu" data-tahap="1">
                </div></td>
                  <td><div class="form-group">
                  <input type="text" id="waktu" class="dataSosial" data-idGejala="<?php echo "$a[idData]"?>" value="<?php foreach ($nilai_sosial as $b) {if ($b['idData']==$a['idData']){print_r($b['keterangan']); }};?> " name="waktu" placeholder="Masukkan waktu" data-namaKolom="keterangan" data-tahap="1">
                </div></td>
        ...
        $(".sosial").change(function() { 
          ...
          console.log(psikomotor);
            if(psikomotor=="sosial3") { 
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_sosial'); ?>",
