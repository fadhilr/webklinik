...
<div class="box box-primary">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="#ambil" data-toggle="tab">Perkembangan Sosial</a></li> 
              <li><a href="#adhd" data-toggle="tab">Perkembangan ADHD</a></li>
              <li><a href="#autis" data-toggle="tab">Perkembangan Autis</a></li>
              
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="ambil">
                 <form action="<?php echo base_url(); ?>c_karyawan/set_psikomotor" method="post">
           <div class="box-body">
        ...
        <tr data-id="DataPsikomotor" >
                  ...
                  <input type="text" id="waktu" class="dataSosial" data-idGejala="<?php echo "$a[idData]"?>" value="<?php foreach ($nilai_sosial as $b) {if ($b['idData']==$a['idData']){print_r($b['waktu']); }};?> " name="waktu" placeholder="Masukkan waktu" data-namaKolom="waktu" data-tahap="2">
                </div></td>
                  <td><div class="form-group">
                  <input type="text" id="waktu" class="dataSosial" data-idGejala="<?php echo "$a[idData]"?>" value="<?php foreach ($nilai_sosial as $b) {if ($b['idData']==$a['idData']){print_r($b['keterangan']); }};?> " name="waktu" placeholder="Masukkan waktu" data-namaKolom="keterangan" data-tahap="2">
                </div></td>
        ...
        ?>
                 <tr>
                  <td>Hasil</td>
                  <td></td>
                  <td><?php foreach ($nilai_sosial as $b) {if ($b['idData']==$a['idData']){print_r($b['nilai']); }};?></td>
                </tr>
                </tbody>
                <tfoot>
                <tr>
        ...
        <tr data-id="DataADHD" >
                  ...
                  <td><input type="radio" name="adhd<?php echo "$a[idGejala]"?>" class="adhd" data-idGejala="<?php echo "$a[idGejala]"?>" id="adhd1" value="" <?php foreach ($nilai_adhd as $b) {
                    if ($b['idGejala']==$a['idGejala'] && $b['idPelanggan']==$idPelanggan)
                      {if ($b['nilai']==1)
                        {echo "checked" ;}
                      }
                    };
                      ?> ></td>
                  <td><input type="radio" name="adhd<?php echo "$a[idGejala]"?>" class="adhd" data-idGejala="<?php echo "$a[idGejala]"?>" id="adhd2" value="" <?php foreach ($nilai_adhd as $b) {if ($b['idGejala']==$a['idGejala'] && $b['idPelanggan']==$idPelanggan){if ($b['nilai']==0){echo "checked";}}};?>></td>
        ...
        <tr data-id="DataAutis" >
                  <td><?php echo "$a[idGejala]"?></td>
                  <td><?php echo "$a[gejala]" ?></td>
                  <td><input type="radio" name="autis<?php echo "$a[idGejala]"?>" class="autis" data-idGejala="<?php echo "$a[idGejala]"?>" id="autis1" value="" <?php foreach ($nilai_autis as $b) {if ($b['idGejala']==$a['idGejala'] && $b['idPelanggan']==$idPelanggan){if ($b['nilai']==1){echo "checked";}}};?>></td>
                  <td><input type="radio" name="autis<?php echo "$a[idGejala]"?>" class="autis" data-idGejala="<?php echo "$a[idGejala]"?>" id="autis2" value="" <?php foreach ($nilai_autis as $b) {if ($b['idGejala']==$a['idGejala'] && $b['idPelanggan']==$idPelanggan){if ($b['nilai']==0){echo "checked";}}};?>></td>
     ...
     $(document).ready(function(){
        $(".sosial").change(function() { 
          ...
          console.log(psikomotor);
            if(psikomotor=="sosial3") { 
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_sosial2'); ?>",
                    data: { idPelanggan:idPelanggan, idKaryawan:idKaryawan, idData:idData, strState:30 }
                });
            } else if(psikomotor=="sosial2") { 
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_sosial2'); ?>",
  ...
  $(document).ready(function(){
        $(".dataSosial").change(function() { 
          ...
          console.log(idData);
                ...
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_data_sosial'); ?>",
      ...
      $(document).ready(function(){
        $(".adhd").change(function() { 
          ...
          console.log(adhd);
            if(adhd=="adhd1") { 
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_adhd'); ?>",
      ...
      $(document).ready(function(){
        $(".autis").change(function() { 
          ...
          console.log(tunalaras);
            if(tunalaras=="autis1") { 
                $.ajax({
                    url: "<?php echo base_url('c_karyawan/set_autis'); ?>",
                    data: { id:id, idGejala:idGejala, strState:1 }
                });
            } else {
                $.ajax({
